...
/// 获取目录
#[frb(sync)]
pub fn get_toc(source_json: String, book_url: String) -> Result<Vec<ChapterItem>, String> {
    toc::get_toc(&source_json, &book_url)
}

/// 获取章节正文
#[frb(sync)]
pub fn get_content(source_json: String, chapter_url: String) -> Result<String, String> {
