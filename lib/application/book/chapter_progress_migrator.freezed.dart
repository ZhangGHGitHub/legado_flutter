...
part of 'chapter_progress_migrator.dart';
...
abstract class $ChapterProgressCopyWith<$Res> {
  ...
  @useResult
  $Res call({int chapterIndex, int chapterPos});
}
...
class _$ChapterProgressCopyWithImpl<$Res, $Val extends ChapterProgress>
  ...
  @override
  $Res call({Object? chapterIndex = null, Object? chapterPos = null}) {
    return _then(
      _value.copyWith(
...
class _$ChapterProgressImpl implements _ChapterProgress {
  ...
  @override
  String toString() {
    return 'ChapterProgress(chapterIndex: $chapterIndex, chapterPos: $chapterPos)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, chapterIndex, chapterPos);
