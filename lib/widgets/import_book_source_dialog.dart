  ...
  void initState() {
    ...
    _kinds = [
      for (final c in widget.candidates)
        classifyBookSourceImport(c, widget.existingByUrl[c.bookSourceUrl]),
    ];
  }

  Future<void> _import(SourceNotifier notifier) async {
    final selected = [
    ...
    final ok = await notifier.importParsedSources(selected);
    if (!mounted) return;
    Navigator.pop(context);
