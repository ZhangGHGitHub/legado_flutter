...
class MoreSettingsPanel extends StatefulWidget {
  ...
  static Future<void> show(
    ...
    return showModalBottomSheet<void>(
      ...
      builder: (_) =>
          MoreSettingsPanel(settings: settings, onChanged: onChanged),
    );
  }
            ...
            child: Column(
              ...
              children: [
                ...
                SwitchListTile(
                  ...
                  onChanged: (v) => _update(_s.copyWith(hideNavigationBar: v)),
                ),
                SwitchListTile(
                  dense: true,
                  contentPadding: const EdgeInsets.symmetric(horizontal: 16),
                  ...
                  onChanged: (v) => _update(_s.copyWith(expandIntoCutout: v)),
                ),
                SwitchListTile(
                  dense: true,
                  contentPadding: const EdgeInsets.symmetric(horizontal: 16),
                  ...
                  onChanged: (v) => _update(_s.copyWith(textFullJustify: v)),
                ),
                SwitchListTile(
                  dense: true,
                  contentPadding: const EdgeInsets.symmetric(horizontal: 16),
                  ...
                  onChanged: (v) => _update(_s.copyWith(textBottomJustify: v)),
                ),
