...
import '../infrastructure/book/book_read_status_port_adapter.dart';
...
import '../infrastructure/bookshelf/bookshelf_book_lifecycle_port_adapter.dart';
    ...
    return (
      app: MultiProvider(
        providers: [
          ...
          Provider<BookReadStatusPort>.value(
            value: BookReadStatusPortAdapter(
              update: bootstrap.bookProvider.updateReadIteration,
            ),
          ),
          ...
          Provider<RemoteBookImportPort>.value(
            value: RemoteBookImportPortAdapter(
              ...
              importLocalBookFromPath:
                  bootstrap.bookProvider.importLocalBookFromPath,
            ),
          ),
          ...
          Provider<BookshelfBookLifecyclePort>.value(
            value: BookshelfBookLifecyclePortAdapter(
              addBook: bootstrap.bookProvider.addBook,
              persistCurrentTocFor: bootstrap.bookProvider.persistCurrentTocFor,
              removeBook: bootstrap.bookProvider.removeBook,
            ),
          ),
          ...
          Provider<ReaderChapterRefreshPort>.value(
            value: ReaderChapterRefreshPortAdapter(
              loadChapters: bootstrap.bookProvider.loadChapters,
              currentChapters: () => bootstrap.bookProvider.currentChapters,
            ),
          ),
          Provider<ReaderChapterListPort>.value(
            value: ReaderChapterListPortAdapter(
              chapters: () => bootstrap.bookProvider.currentChapters,
            ),
          ),
          Provider<ReaderSimulatedReadingPort>.value(
            value: ReaderSimulatedReadingPortAdapter(
              findBookById: bootstrap.bookProvider.findBookById,
              updateSimulatedReading:
                  bootstrap.bookProvider.updateSimulatedReading,
            ),
          ),
