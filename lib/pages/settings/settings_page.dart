            ...
            child: Column(
              children: [
                ...
                _Row(
                  ...
                  '主题模式',
                  '浅色 / 深色模式切换',
                  trailing: Switch(value: _darkMode, onChanged: _toggle),
                ),
                _Div(),
                _Row(
...
class _Div extends StatelessWidget {
  @override
  Widget build(BuildContext c) => const Divider(height: 1, indent: 56);
}
...
class _IconBtn extends StatelessWidget {
  ...
  Widget build(BuildContext c) => GestureDetector(
    ...
    child: SizedBox(
      ...
      child: Column(
        children: [
          Icon(icon, size: 28, color: Theme.of(c).colorScheme.primary),
