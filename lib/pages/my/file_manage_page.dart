...
class _FileManagePageState extends State<FileManagePage> {
  ...
  Directory? get _lastDir =>
      _subDocs.isEmpty ? _root : _subDocs.last;
  ...
  Future<void> _showFileMenu(Offset globalPosition, FileSystemEntity entity) async {
    final last = _lastDir;
    if (last != null &&
        entity is Directory &&
        p.equals(entity.path, last.path) &&
  ...
  Widget build(BuildContext context) {
    ...
    final showEmpty =
        !_loading && _error == null && visible.isEmpty;
