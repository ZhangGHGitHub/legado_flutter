...
class SimulationCurlPainter extends CustomPainter {
  ...
  void _drawCurrentPageShadow(Canvas canvas, CurlPoints p, Path path0) {
    ...
    final degree = p.isRtOrLb
        ? math.pi / 4 -
            math.atan2(p.bezierControl1.dy - p.touchY, p.touchX - p.bezierControl1.dx)
        : math.pi / 4 -
            math.atan2(p.touchY - p.bezierControl1.dy, p.touchX - p.bezierControl1.dx);
