...
| 批量操作 | 启用/禁用/发现/分组/置顶/导出/分享/校验/删除 | ✅ Wave 1 底栏「更多」补齐 | 添加/移除分组为单分组语义（Wave 2 逗号多标签） |
...
#### Task UI-4: 书源管理对齐 (`sources_page.dart`) — 🟡 Wave 1 完成（2026-07-21）；Wave 2 仍开放
...
- [ ] **Wave 2**：导入预览 Dialog、校验关键词+设置、逗号多分组、帮助页、滑动多选、行内校验 debug 文案
...
Task UI-4:  书源管理 Wave 1（排序/行/底栏）  🟡 Wave 1 完成（2026-07-21）；Wave 2 仍开放
...
| 书源管理 | 97% | UI-4 Wave 1（2026-07-21）：排序/拖拽/行菜单/底栏更多；Wave 2（导入预览/校验设置/多分组/帮助）仍开放 |
