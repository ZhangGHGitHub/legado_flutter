...
- 本批只收敛公开错误契约，不覆盖浏览器宿主、WebView 生命周期、重复公开 FRB 子模块入口或其它公开 `Result<T, String>`；不改变正文、目录、分页、章节身份、UTF-16 阅读位置或第 3 条断行规则。
